package io.javashiv.ipldashboard.data;
...
public class JobCompletionNotificationListener extends JobExecutionListenerSupport {
    ...
    public void afterJob(JobExecution jobExecution) {
        if (jobExecution.getStatus() == BatchStatus.COMPLETED) {
            ...
            /*
             * This is just used to print the information from csv while reading it with
             * spring batch jdbcTemplate.query("SELECT team1, team2, date FROM match", (rs,
             * row) -> "Team 1 " + rs.getString(1) + "Team 2 " + rs.getString(2) + "Date " +
            ...
            teamData.values().forEach(team -> System.out.println("team name" + team.getTeamName() + " total matches: "
                    + team.getTotalMatches() + " total wins: " + team.getTotalWins()));
        }
    }
}